...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (leadMobile) {
    document.getElementById("leadMobile").textContent = leadEmail;
  }
  ...
  if (editInvoiceButton) {
    editInvoiceButton.href = `edit-invoice.html?leadName=${leadName}&leadEmail=${leadEmail}&leadMobile=${leadMobile}`;
  }
});
